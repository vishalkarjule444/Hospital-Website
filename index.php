...
<section class="banner" style='background:url("admin/uploads/<?=$banner['banner_image']?>") no-repeat;'>
	<div class="container">
		<div class="row">
			<div class="col-lg-6 col-md-12 col-xl-7">
				<div class="block">
					<div class="divider mb-3"></div>
					<span class="text-uppercase text-sm letter-spacing "><?=$banner['banner_short_title']?></span>
					<h1 class="mb-3 mt-3"><?=$banner['banner_title']?></h1>
					
					<p class="mb-4 pr-5"><?=$banner['banner_details']?></p>
	...
	<div class="container">
		<div class="row">
			<div class="col-lg-12">
				...
				<?php
				$schedules = mysqli_query($conn,"SELECT * FROM working_hours");
				?>
					...
					<div class="feature-item mb-5 mb-lg-0">
						...
						<ul class="w-hours list-unstyled">
							...
							{
							?>
		              <li class="d-flex justify-content-between"><?=$row['working_days']?>  <span><?=$row['working_schedule']?></span></li>
		              <?php
		          		}
		          		?>
		                </ul>
...
$about_services = mysqli_fetch_assoc($result);
?>
	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-4 col-sm-6">
				<div class="about-img">
					<img src="admin/uploads/<?=$about_services['image1']?>" alt="" class="img-fluid">
					<img src="admin/uploads/<?=$about_services['image2']?>" alt="" class="img-fluid mt-4">
				</div>
			</div>
			<div class="col-lg-4 col-sm-6">
				<div class="about-img mt-4 mt-lg-0">
					<img src="admin/uploads/<?=$about_services['image3']?>" alt="" class="img-fluid">
				</div>
			</div>
			<div class="col-lg-4">
